...
class Game:
    ...
    def game_loop(self):
        ...
        while self.is_running:
            ...
            # Check for notification reminders at the start of each turn
            notification_reminder = self.player.notification_manager.new_turn()
            ...
            if cmd_entry:
                ...
                for member in gang_members:
                    ...
                    if interaction_result:
                        ...
                        if any(keyword in interaction_result.lower() for keyword in 
                              ["gives you", "gift", "offers you", "insists you take", 
                               "damage", "defeated", "attacks"]):
                            self.player.notification_manager.add_notification(
                                interaction_result, 
                                category="combat" if "damage" in interaction_result.lower() else "item", 
                                importance=4 if "damage" in interaction_result.lower() else 2
                            )
                    ...
                    if death_message:
                        ...
                        print(death_message)
                        # Add to notifications with high importance
                        self.player.notification_manager.add_notification(
                            death_message, 
                            category="combat", 
                            importance=5
                ...
                # Get summarized NPC messages and print them
    ...
    def cmd_notifications(self, args):
        """View your notifications. Usage: notifications [count] [category]"""
        count = None
        category = None
    ...
    def cmd_clear_notifications(self, args):
        """Clear all notifications. Usage: clear notifications"""
