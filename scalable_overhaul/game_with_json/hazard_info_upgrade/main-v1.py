...
class Game:
    ...
    def game_loop(self):
        ...
        while self.is_running:
            ...
            if unread_count > 0:
                ...
                # should we clear notifications here?
            else:
                print(location_text)
            ...
            if cmd_entry:
                ...
                self.player.notification_manager.read_and_clear_notifications()
            else:
    ...
    def cmd_notifications(self, args):
        ...
        notifications_text, remaining = self.player.notification_manager.read_and_clear_notifications(count, category)
