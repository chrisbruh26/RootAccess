...
class NPCMessageManager:
    ...
    def __init__(self):
        ...
        self.summarize_threshold = 1  # Number of messages before summarizing
    ...
    def add_message(self, message):
        ...
        if npc_name:
            ...
            if action_type in ["unnoticed", "looking_away", "distracted"]:
                ...
                if has_detection_message or random.random() > 0.2:
                    return None
    ...
    def _create_summary(self):
        ...
        for message in self.message_buffer:
            ...
            # All detection-related messages - consolidate into a single category
                  ...
                  "walks past your hiding spot" in message):
        ...
        summary_parts = []
        max_summary_parts = 4  # Limit the number of summary parts to display
        ...
        # Only show "unaware" messages very occasionally (1 in 5 turns) unless we have very few messages
        if unaware_members and (len(summary_parts) < 1 or random.random() < 0.2) and len(summary_parts) < max_summary_parts:
