...
class MessageCoordinator:
    ...
    def _generate_action_summary(self):
        ...
        if "npc_attack" in npcs_by_action:
            for _, _, message in npcs_by_action["npc_attack"]:
                summary_parts.append(message)
        
        # Process other action types in order of importance
        priority_order = [
            "npc_gift", "npc_gardening", "hazard_trigger", 
            "npc_hallucination_detail", "npc_falling_object", 
            "npc_interact", "npc_talk", "npc_idle"
        ]
