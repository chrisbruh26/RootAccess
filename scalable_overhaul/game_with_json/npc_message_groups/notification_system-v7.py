        ...
        for category, notifications in notifications_by_category.items():
            ...
            for i, notification in enumerate(notifications, 1):
                ...
                if not notification.read:
                    ...
                    self.unread_count = max(0, self.unread_count - 1)  # Ensure it doesn't go below 0
        
        # Reset the last reminder turn to avoid immediate reminders after viewing
        self.last_reminder_turn = self.turn_counter
        
        # Only show remaining unread count if there are any
