        ...
        for effect_variant, members in affected.items():
            ...
            if count == 1:
                ...
                if count <= max_names:
                    ...
                    remainder_phrase = random.choice(NPC_REACTIONS.get(f"possible_{effect_variant.replace(' ', '_')}", {}).get("group_remainder", []))
        ...
        while self.is_running:
            ...
            if cmd_entry:
                ...
                if hallucinating_members:
                    ...
                    if random.random() < 0.5:  # 50% chance to show message
                        if len(hallucinating_members) == len(gang_members):
                            ...
                            undetected_msg = random.choice(NPC_REACTIONS.get("possible_hallucinations", {}).get("player_undetected", ["don't see you because they are too distracted from hallucinating."]))
                            print(f"The {gang_name} members {names} {undetected_msg}")
