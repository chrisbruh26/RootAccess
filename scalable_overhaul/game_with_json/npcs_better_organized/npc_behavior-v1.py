...
class NPCMessageManager:
    ...
    def __init__(self):
        ...
        self.last_turn_hallucination_reported = False  # Track if we reported hallucinations last turn
    ...
    def _should_skip_message(self, message):
        ...
        # Skip most hallucination messages if we've already reported them
        if "is so high" in message or "hallucinating" in message:
            if self.last_turn_hallucination_reported:
    ...
    def _create_summary(self):
        ...
        for message in self.message_buffer:
            ...
            # Hallucination messages
                ...
                self.last_turn_hallucination_reported = True
            # Friendly messages
        ...
        # Add a few other messages if we don't have many important ones
