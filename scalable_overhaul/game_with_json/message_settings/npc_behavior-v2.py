...
class BehaviorSettings:
    ...
    def __init__(self):
        ...
        self.default_weights = {
            BehaviorType.IDLE: 0.4,      # 40% chance for idle behavior
            BehaviorType.TALK: 0.3,      # 30% chance for talking
            BehaviorType.FIGHT: 0.1,     # 10% chance for fighting
            BehaviorType.USE_ITEM: 0.2,  # 20% chance for using items
        ...
        self.cooldowns = {
            BehaviorType.IDLE: 0,      # No cooldown for idle
...
class BehaviorManager:
    ...
    def update(self, game):
        ...
        if behavior_settings.can_perform_behavior(self.npc, BehaviorType.USE_ITEM, current_turn):
    ...
    def choose_next_behavior(self, game):
        ...
        # If no valid behaviors, default to idle
