...
class MessageCategory(enum.Enum):
    ...
    HAZARD_EFFECT = 6  # Hazard effects on NPCs/environment
    AMBIENT = 7  # Ambient/environmental messages
    
    # Category 4: Least important, rare or never shown
    TRIVIAL = 8  # Very minor events
    DEBUG = 9  # Debug information
    ...
    def __init__(self, game):
        ...
        self.category_keywords = {
            ...
            MessageCategory.NPC_MINOR: [
                "walks", "sits", "stands", "looks", "watches", "waits", "talks",
                "whispers", "mutters", "gestures", "nods", "shakes head"
            ],
            MessageCategory.HAZARD_EFFECT: [
                "affected:", "hallucination", "poison", "radiation", "electric",
