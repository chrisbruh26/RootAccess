...
class GangMember(NPC):
    def __init__(self, name, description, gang):
        ...
        self.hazard_resistance = 0.05  # Base 5% chance to resist hazard effects (0.05 = 5%)
    ...
    def apply_hazard_effect(self, hazard):
        ...
        if random.random() < self.hazard_resistance:
            ...
            return f"The {self.gang.name} member {self.name} resisted and {resistance_message}"
        ...
        if hazard.effect == "hallucinations":
            ...
            return f"The {self.gang.name} member {self.name} is hallucinating and {hallucination}"
...
class UseItemBehavior(Behavior):
    ...
    def _trigger_hazard(self, game):
        ...
        if not item_in_inventory and not item_in_area:
            ...
            # Only return the message 25% of the time to reduce spam
            if random.random() < 0.25:
                return f"{self.npc.name} looks for the {item_name}, but it's no longer there."
            return None
